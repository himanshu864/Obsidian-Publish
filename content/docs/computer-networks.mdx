...
![Screenshot 2025-01-02 at 1.12.06 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-01-02%20at%201.12.06%20PM.png)
...
![Pasted image 20250102133339.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Pasted%20image%2020250102133339.png)
...
![Screenshot 2025-01-02 at 5.35.58 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-01-02%20at%205.35.58%20PM.png)
...
![Pasted image 20250102174423.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Pasted%20image%2020250102174423.png)
...
![Screenshot 2024-11-22 at 3.39.13 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202024-11-22%20at%203.39.13%20PM.png)
...
![Screenshot 2024-11-22 at 4.21.19 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202024-11-22%20at%204.21.19%20PM.png)
...
![Screenshot 2024-11-22 at 4.32.10 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202024-11-22%20at%204.32.10%20PM.png)
...
```math
\gamma
``` rays -&gt; X rays -&gt; UV -&gt; visible -&gt; IR -&gt; Microwaves -&gt; FM -&gt; AM -&gt; Long wave lengths
...
![Screenshot 2024-11-21 at 1.37.38 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202024-11-21%20at%201.37.38%20PM.png)
...
![Screenshot 2024-11-21 at 1.42.49 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202024-11-21%20at%201.42.49%20PM.png)
...
![Screenshot 2024-11-21 at 1.51.24 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202024-11-21%20at%201.51.24%20PM.png)
...
![Screenshot 2024-11-21 at 1.54.15 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202024-11-21%20at%201.54.15%20PM.png)
...
![Screenshot 2025-02-26 at 3.56.47 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-26%20at%203.56.47%20PM.png)
...
![Screenshot 2025-02-26 at 4.22.25 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-26%20at%204.22.25%20PM.png)
...
```
![Screenshot 2025-02-26 at 4.55.17 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-26%20at%204.55.17%20PM.png)
...
T_{fr}
```)**
Time taken by sender to send all bits in packets. If first bit is put on line at time 
```math
t_1
``` and last bit on 
```math
...
![Screenshot 2025-02-26 at 9.06.30 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-26%20at%209.06.30%20PM.png)
...
```
i.e. No station should send any frame one 
```math
T_{fr}
``` before or one 
```math
T_{fr}
``` after, the start of transmission of current frame.
...
```
### Slotted Aloha
To improve efficiency of pure aloha, we send frames only in slots of 
```math
T_{fr}
``` time.

Now vulnerable time is reduces to half of pure. i.e. 
```math
T_{fr}
``` Hence, efficiency doubled 37%.

Synchronous.

![Screenshot 2025-02-27 at 12.46.19 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%2012.46.19%20PM.png)
...
Hence, the vulnerable time is 
```math
T_p
```

![Screenshot 2025-02-27 at 11.47.18 AM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%2011.47.18%20AM.png)
...
**P-persistence method**: Continuously senses if station is idle and starts generating probability 
```math
p
``` at time slots to send frame per station if it's probability if more than 
```math
p
```.

![Screenshot 2025-02-27 at 11.46.24 AM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%2011.46.24%20AM.png)
...
![Screenshot 2025-02-27 at 12.09.57 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%2012.09.57%20PM.png)
...
![Screenshot 2025-02-27 at 12.27.39 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%2012.27.39%20PM.png)

**Acknowledgement**
Use positive acknowledgements and time-out timer to guarantee receiver receives the frame.

![Screenshot 2025-02-27 at 12.45.17 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%2012.45.17%20PM.png)
...
```math
Delay_{qu}
``` = Time packet waits in input and output queues in a router.

**Processing Delay**

```math
Delay_{pr}
``` = Time required to process a packet at destination host.
...
```
- Delays are generally zero for numerical, along with 
```math
T_{t(ack)}
```, since small size.
...
```math
2 \times T_p
``` is also called Round Trip Time (RTT).
...
Send window covers sequence number of frames that can be transit, max value 
```math
= 2^m - 1
```

![Screenshot 2025-02-27 at 1.44.55 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%201.44.55%20PM.png)
...
![Screenshot 2025-02-27 at 1.47.17 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%201.47.17%20PM.png)
...
```math
W_s
``` (window size) packets are send together, our efficiency improves.
...
Receiver stores frames in wrong order until they can be arranged properly. Hence, require equal room for sending and receiving frames to work more efficiently. i.e. 
```math
2^{m - 1}
```

![Screenshot 2025-02-27 at 1.58.45 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%201.58.45%20PM.png)
...
![Screenshot 2025-02-27 at 4.01.10 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%204.01.10%20PM.png)
...
![Screenshot 2025-02-27 at 4.34.14 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%204.34.14%20PM.png)
...
- Parity bits 
```math
= 2^0, 2^1, \ldots 2^{r - 1} = 1, 2, 4
```
	- 
```math
P_1
``` bit takes one and leaves one. i.e. 1,3,5,7
	- 
```math
P_2
``` bit takes one and leaves one. i.e. 2,3,6,7
	- 
```math
P_3
``` bit takes one and leaves one. i.e. 4,5,6,7
...
- Size of the dataword is augmented by adding 
```math
n - k
...
```math
n
```-bit result is fed into the generator.
- Generator uses a divisor of size 
```math
n - k + 1
...
Index codeword from 0 to 
```math
n - 1
```, which work as powers and 0/1's are co-efficients.
...
![Screenshot 2025-02-27 at 6.03.43 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-27%20at%206.03.43%20PM.png)
...
![Screenshot 2025-02-28 at 12.54.50 AM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-28%20at%2012.54.50%20AM.png)
...
![Screenshot 2025-02-28 at 1.39.54 AM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-28%20at%201.39.54%20AM.png)
...
![Screenshot 2025-02-28 at 2.24.57 AM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-28%20at%202.24.57%20AM.png)
...
![Screenshot 2025-02-28 at 9.21.14 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-02-28%20at%209.21.14%20PM.png)
...
- IPv4 are 32bits in length. Giving 
```math
2^{32}
``` addresses. Over 4 billion possible devices. smol.
- IPv6 is 128 bits in length. Which is over 
```math
3.4 \times 10^{38}
``` devices. Too big.
...
![Screenshot 2024-11-22 at 5.06.44 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202024-11-22%20at%205.06.44%20PM.png)
...
1. The number of addresses in a /28 block is calculated as  
```math
2^{(32 - 28)} = 2^4 = 16
```
...
![Screenshot 2025-05-19 at 4.51.43 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-05-19%20at%204.51.43%20PM.png)
...
- To define processes inside a host, we need secondary identifiers called **port numbers**. They are 16-bits integers ranging from 
```math
0
``` to 
```math
...
![Pasted image 20250519173608.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Pasted%20image%2020250519173608.png)

- 16 bits for source and destination port address.
- **Sequence Number (32 bits)**
	- To ensure connectivity, each byte is numbered in the range 
```math
[0, 2^{32} - 1]
```.
...
![Screenshot 2025-05-19 at 9.25.44 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202025-05-19%20at%209.25.44%20PM.png)
...
- **Disadvantages**
    ...
    - **Scalability**: with n parties, 
```math
\tfrac{n(n-1)}{2}
``` keys are needed for pairwise secure channels.
- **Typical Use Cases**
...
1. **Pick two large prime numbers**, 
```math
p
``` and 
```math
...
1. Convert your message into a number 
```math
m
```.
...
* Multiplying two large primes is easy; factoring the product back into 
```math
p
``` and 
```math
...
```math
m
``` by computing the modular root is infeasible for large keys.
...
```math
(n,e)
``` → used by everyone to **encrypt**.
* **Private key** 
```math
(n,d)
``` → used only by you to **decrypt**.
...
![Screenshot 2024-12-01 at 10.45.48 PM.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Screenshot%202024-12-01%20at%2010.45.48%20PM.png)
### POP3 vs IMAP
...
![Pasted image 20250520015737.png](https://raw.githubusercontent.com/himanshu864/DevObs/refs/heads/main/Assets/Pasted%20image%2020250520015737.png)
