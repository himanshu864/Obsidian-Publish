...
| **Domain & Hosting for Policies** | **
```math
10–20/year** (domain) + hosting (
```5–10/mo) | Privacy policy, terms, refund policy must be online. You already have `thescenezone.com`, so just hosting/maintenance. |
